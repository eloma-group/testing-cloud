  ...
  return (
    <section className="cc-sl" aria-label="Always-on support">
      <style>{`
        ...
        .cc-sl-lead {
          font-family: 'Inter', sans-serif; margin: clamp(14px, 1.5vw, 22px) 0 0;
        ...
        .cc-sl-card h3 {
          margin: 0 0 6px; font-family: 'Inter', sans-serif; font-weight: 800; text-transform: uppercase;
        ...
        .cc-sl-meter-t span {
          font-family: 'Inter', sans-serif; font-size: clamp(13px, 0.95vw, 15px);
        ...
        .cc-sl-trust-l p {
          ...
          font-family: 'Inter', sans-serif; font-size: clamp(14px, 1.05vw, 16px);
