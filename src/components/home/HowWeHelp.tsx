  ...
  return (
    <section className="cc-hw" id="how-we-help" aria-label="How we help">
      <style>{`
        ...
        .cc-hw-lead {
          font-family: 'Eloma Sans', sans-serif; font-size: clamp(15px, 1.2vw, 18px); line-height: 1.72;
        ...
        .cc-hw-num {
          ...
          font-family: 'Eloma Sans', sans-serif; font-weight: 600; letter-spacing: -0.06em;
        ...
        .cc-hw-metric {
          ...
          font-family: 'Eloma Sans', sans-serif; font-weight: 700 !important;
        ...
        .cc-hw-go {
          ...
          font-family: 'Eloma Sans', sans-serif; font-weight: 700; font-size: clamp(12px, 0.9vw, 14px);
