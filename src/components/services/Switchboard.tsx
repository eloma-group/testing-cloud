  ...
  return (
    <section className="sw-band" aria-label="Services">
      <style>{`
        ...
        .sw-jack em {
          display: block; font-style: normal; font-family: 'Eloma Sans', sans-serif; font-weight: 800;
        ...
        .sw-card-body .body {
          ...
          border-bottom: 1px solid #2F2A42;
          font-family: 'Eloma Sans', sans-serif; font-size: clamp(13px, 1.02vw, 16px); line-height: 1.85;
          color: #BDBDBD;
        }
        ...
        .sw-does span {
          ...
          font-family: 'Eloma Sans', sans-serif; font-weight: 600; font-size: clamp(11px, 0.88vw, 13px);
          color: #C3BCFF;
        }
        ...
        .sw-figs span {
          display: block; margin-top: 7px; font-family: 'Eloma Sans', sans-serif; font-weight: 600;
