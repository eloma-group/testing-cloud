  ...
  return (
    <PageShell>
      <style>{`
        ...
        .sv-fig-row b {
          font-family: 'Eloma Sans', sans-serif; font-weight: 600; font-size: clamp(13px, 1.05vw, 16px); color: ${TEXT};
        }
        .sv-fig-row time {
        ...
        .sv-out p {
          margin: 0; max-width: 52ch; font-family: 'Eloma Sans', sans-serif;
